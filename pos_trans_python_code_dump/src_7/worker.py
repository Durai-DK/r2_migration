...
# from daily_archive import archive_yesterday_stats
...
async def on_fetch(request, env, ctx):
    try:
        ...
        # ---------------   GET STATS   ---------------
        # if path == "/api/pos-bucket/stats" and request.method == "GET":
        #     params = parse_qs(parsed.query)
        #     date_param = params.get("date", [None])[0]
        #
        #     return await get_stats_api(env, date_param, request)
...
#     await archive_yesterday_stats(env)
