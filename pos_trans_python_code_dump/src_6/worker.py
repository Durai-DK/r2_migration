...
from create_records import handle_post_records, handle_main_queue, handle_summary_queue, handle_dlq_queue
...
async def on_queue(batch, env, ctx):
    ...
    elif queue_name == "pos-transaction-python-dlq":
        await handle_dlq_queue(batch, env)
