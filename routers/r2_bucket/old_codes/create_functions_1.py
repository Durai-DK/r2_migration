...
#     invoice_path = f"{mob_prefix}/{mobile}/invoices/{invoice_id_fix}_{pri_id}.json"
#
#
#     invoice_metadata = {
...
#
#     # Store invoice
#     store_json_data(mob_bucket, data, invoice_path, invoice_metadata)
#
#     serial_numbers = [s.strip() for s in serial_no.split(",") if s.strip()]
#
#     for sn in serial_numbers:
#         imei_mob_path = f"{mob_prefix}/{mobile}/imei_numbers/{sn}.json"
#         store_json_data(mob_bucket, data, imei_mob_path, invoice_metadata)
#
#         imei_path = f"{imei_prefix}/{sn}.json"
#         store_json_data(imei_bucket, data, imei_path, invoice_metadata)
#
#
